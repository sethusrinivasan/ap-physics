...
Q5 = (ROOT / "unit2-q5" / "index.html").read_text()
AUDIO_GEN = (ROOT / "unit2-q5" / "generate-audio.mjs").read_text()
JUNK = re.compile(
...
def main() -> None:
    ...
    for n in range(1, total + 1):
        patch_nav(n, total)
        assert_layout((ROOT / f"unit2-q{n}" / "index.html").read_text(), f"final Q{n}")
